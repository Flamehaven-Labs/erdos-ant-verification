...
Version (paper source) & v0.2.3 \\
Tagged paper revisions & v0.1.3 (first paper-bearing); v0.1.4 (placeholder fill-in); v0.2.0 (positioning pass); v0.2.1 (source-alignment audit); v0.2.2 (public naming alignment); v0.2.3 (PDF readability and public-source framing) \\
