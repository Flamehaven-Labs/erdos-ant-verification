...
prime that is $3 \pmod 4$ (e.g.\ $3$, $7$, or $11$), the source
argument quotes the corresponding genus-theoretic rank count as
$|T| - 1 = 5$,
giving
\[
  d(G_T^\infty) = |T| - 1 = 5.
\]
The artifact records and tests this finite rank count; it does not
reprove the class-field-theoretic rank formula.
...
\]
with positive finite margin $0.25$. By the cited Golod--Shafarevich theorem
