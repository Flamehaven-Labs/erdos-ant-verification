...
\texttt{tests/test\_imaginary\_quadratic\_lattice.py::%
test\_gaussian\_3x3\_grid\_has\_12\_unit\_distances}.
\end{verification}
...
pairs.
\textit{Source:
\texttt{src/erdos\_ant/imaginary\_quadratic\_lattice.py},
class \texttt{ImaginaryQuadraticLattice.count\_unit\_distance\_pairs}.}
Pinned in \texttt{src/erdos\_ant/verify.py} as the assertion
\texttt{phase1\_gaussian\_7x7\_grid\_has\_expected\_84\_pairs}.
\end{verification}
...
\texttt{test\_eisenstein\_unit\_distances\_exceed\_gaussian\_for\_same\_bound}.
\end{verification}
