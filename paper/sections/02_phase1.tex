...
\medskip
The later Baker--Heegner--Stark cases are not needed for the
eq.~(2.2) reproduction and introduce no new mechanism for this
artifact: they change the quadratic basis but not the finite
embedding/counting pattern used here. We therefore keep Phase~1 as a
minimal exact reference rather than a catalogue of all class-number-one
quadratic fields.
