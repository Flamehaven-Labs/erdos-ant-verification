...
This section states the boundary of the artifact before the
reproducibility details. The goal is not to diminish the reproduction,
but to keep the numerical result, proof input, and peer-review status
separate.
...
are the following reproducible evidence surfaces --- none of which is a
...
\cite{Sawin2026Remarks}. This is a text-search and source-review claim,
not a formal statement about every rendered glyph in the PDFs.
