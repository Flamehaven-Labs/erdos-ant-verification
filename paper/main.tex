...
\S\ref{sec:repro}. Per-release Zenodo DOIs and citation metadata are
maintained in \texttt{CITATION.cff} and on the
\href{https://github.com/Flamehaven-Labs/openai-erdos-eq22-reproduction/releases}{GitHub
Releases} page, not inlined here; this keeps the manuscript surface
